  ...
  const chatId = ctx.message.chat.id
    ...
    if (chatId == "5229925261" || chatId == "-1001959268889" && threadID == "14113") {
        ...
        if (linkRegex.test(message)) {
            ...
            if (pee.test(url)){
              const strMess = `<b>Add Video đã bị khóa tính năng, nếu tài khoản của bạn còn có thể add Video hãy giúp mọi người ở đây nhé!</b> \n<b><i>Tất cả đều miễn phí! Hoa hồng là của bạn! 🎉</i></b>${tagName}`
          ctx.replyWithPhoto(`https://shopgarena.net/wp-content/uploads/2023/07/Meo-Xin-Loi-Hai-Huoc.jpg`,{caption: strMess, message_thread_id: threadID, reply_markup: {
                    inline_keyboard: [
